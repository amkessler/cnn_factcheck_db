...
Searchable Database (CNN)
===================================== 
Published CNN fact checks through `r format(d, format="%b %d")`. To filter the list, click on the boxes above the columns. To sort, click on the arrows by the column names. To search globally by keywords, use the search box on the right. 
...
===================================== 
Published fact checks from a curated list of fact-checking and news organization sites. This includes CNN itself but also ones like Politifact, the NYT, AP, etc. 
